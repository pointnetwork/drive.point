        ...
        Swal.fire({
            ...
            html:
              ...
              '<div id="idsFields" class="mb-3" style="text-align: left; margin-top: 10px;" >' +
                '<label for="identities" class="form-label">Identity</label>' +
                '<input placeholder="Identity which you want to share the file" type="text" class="form-control" id="identities" disabled >' + 
