...
const Toolbar = ({newFolderHandler, uploadHandler}) => {
    ...
    return (
        <div className="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
            ...
            <button type="button" className="btn btn-outline-secondary" onClick={uploadHandler}>
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" className="bi bi-file-earmark-arrow-up" viewBox="0 0 16 16">
            ...
            <button type="button" className="btn btn-outline-secondary" onClick={newFolderHandler}>
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" className="bi bi-folder-plus" viewBox="0 0 16 16">
